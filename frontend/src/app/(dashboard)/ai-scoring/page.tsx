...
export default function AIScoringPage() {
  ...
  return (
    <div className="page-container mx-auto max-w-3xl space-y-6">
      <PageHeader
        title="AI Scoring"
        description="Run confidence scoring on companies and contacts with ICP-aware breakdowns."
        badge="Intelligence"
      />
      ...
      <div className="flex gap-1 border-b border-border">
        {(["contact", "company"] as Tab[]).map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
            className={`shrink-0 border-b-2 px-5 py-2.5 text-sm font-medium capitalize transition-colors ${
